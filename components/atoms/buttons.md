...
| ![](../../.gitbook/assets/searchbutton-1%20%281%29.png) | [Search Button](buttons.md#search-button) | The search button is a variant of the icon button. It is a submit button included in the search bar, for the form to reduce the number of keystrokes required to use the form. On mobile, it will reduced to the icon. The magnifying glass is universally recognized by users as an indicator of search, and doesn’t need to be visually paired with the word "Search" as long as it remains for screen readers. |
...
{% tabs %}
{% tab title="Visual" %}
![](../../.gitbook/assets/screen-shot-2018-08-09-at-2.39.01-pm-1.png)
{% endtab %}
...
{% tabs %}
{% tab title="Visual" %}
![](../../.gitbook/assets/screen-shot-2018-08-09-at-2.22.08-pm-1%20%281%29.png)
{% endtab %}
...
{% tabs %}
{% tab title="Visual" %}
![](../../.gitbook/assets/iconbutton-1.png)
{% endtab %}
